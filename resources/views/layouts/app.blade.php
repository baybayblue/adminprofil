                                    ...
                                    <div class="mainmenu">
                                        <nav>
                                            <ul id="nav">
                                                ...
                                                <li class="current"><a href="index.html">Profil <i class="fa fa-angle-down"></i></a>
                                                    <ul class="sub-menu">
                                                        <li><a href="">Tentang Sekolah</a></li>
                                                        <li><a href="index-3.html">Visi dan Misi</a></li>
                                                        <li><a href="index-4.html">Organigram</a></li>
                                                        <li><a href="index-4.html">Jurusan</a></li>
                                                        <li><a href="{{ route('guru.tampil') }}">Guru dan Tata Usaha</a></li>
                                                        <li><a href="{{ route('prestasi.tampil') }}">Prestasi</a></li>
                                                        <li><a href="index-5.html">Keunggulan</a></li>
                                                        <li><a href="{{ route('sarana.tampil') }}">Sarana dan Prasarana</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li><a href="class-grid.html">Informasi <i class="fa fa-angle-down"></i></a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="class-details.html">Pengumuman</a></li>
                                                ...
                                                <li><a href="index.html">Ekstrakurikuler<i class="fa fa-angle-down"></i></a>
                                                    <ul class="sub-menu">
