...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ $profilSekolah && $profilSekolah->logo ? \Illuminate\Support\Facades\Storage::url($profilSekolah->logo) : 'https://adminlte.io/themes/v3/dist/img/AdminLTELogo.png' }}"
            alt="Logo Sekolah" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ auth()->user()->foto ? \Illuminate\Support\Facades\Storage::url(auth()->user()->foto) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=random' }}"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li
                    class="nav-item {{ request()->routeIs('admin.profil.', 'admin.organigram.', 'admin.sarana.', 'admin.galeri.', 'admin.testimoni.*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.profil.index') }}"
                                class="nav-link {{ request()->routeIs('admin.profil.index') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.organigram.index') }}"
                                class="nav-link {{ request()->routeIs('admin.organigram.index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Organigram</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.sarana.index') }}"
                                class="nav-link {{ request()->routeIs('admin.sarana.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                {{-- Grup Menu Publikasi --}}
                <li
                    class="nav-item {{ request()->routeIs('admin.konten.', 'admin.agenda.', 'admin.pengumuman.', 'admin.prestasi.') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.konten.index') }}"
                                class="nav-link {{ request()->routeIs('admin.konten.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Konten (Berita/Artikel)</p>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                {{-- Grup Menu Akademik --}}
                <li
                    class="nav-item {{ request()->routeIs('admin.jurusan.', 'admin.guru.', 'admin.ekstrakurikuler.', 'admin.post-ekstrakurikuler.') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.post-ekstrakurikuler.index') }}"
                                class="nav-link {{ request()->routeIs('admin.post-ekstrakurikuler.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Post Kegiatan Eskul</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.background.index') }}"
                        class="nav-link {{ request()->routeIs('admin.background.index') ? 'active' : '' }}">
